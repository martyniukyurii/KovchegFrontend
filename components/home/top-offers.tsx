...
export function TopOffers() {
  ...
  const properties: Property[] = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&w=1920&q=100",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&w=1920&q=100",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&w=1920&q=100",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&w=1920&q=100",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&w=1920&q=100",
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-1.5">
              <h4 className="font-semibold text-xs text-foreground">
                {t("topOffers.description")}:
              </h4>
              <p className="text-xs text-muted-foreground line-clamp-3">
                {property.category === t("topOffers.categories.apartments") &&
                  t("topOffers.descriptions.apartment")}
                {property.category === t("topOffers.categories.houses") &&
                  t("topOffers.descriptions.house")}
                {property.category === t("topOffers.categories.commercial") &&
                  t("topOffers.descriptions.commercial")}
              </p>
            </div>
            <div className="space-y-1.5">
              <h4 className="font-semibold text-xs text-foreground">
                {t("topOffers.features")}:
              </h4>
              <ul className="text-xs flex flex-wrap gap-1">
                {property.category === t("topOffers.categories.apartments") && (
                  <>
                    <li>
                      • {t("topOffers.offerFeatures.apartments.bedrooms")}
                    </li>
                    <li>
                      • {t("topOffers.offerFeatures.apartments.bathroom")}
                    </li>
  ...
  return (
    <section
      id="top-offers"
      className="min-h-screen flex flex-col justify-center relative py-12"
    >
