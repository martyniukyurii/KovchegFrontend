...
import {Tabs, Tab, Input, Link, Button, Modal, ModalContent, ModalBody, ModalHeader, useDisclosure, Divider} from "@heroui/react";
                ...
                <Tab key="login" title={t('auth.login')}>
                  <AnimatePresence mode="wait">
                    ...
                    >
                      ...
                      <div>
                        <p className="text-center text-sm text-muted-foreground mb-3">{t('auth.orLoginWith')}</p>
                ...
                <Tab key="sign-up" title={t('auth.signUp')}>
                  <AnimatePresence mode="wait">
                    ...
                    >
                      ...
                      <div>
                        <p className="text-center text-sm text-muted-foreground mb-3">{t('auth.orRegisterWith')}</p>
                        <div className="flex gap-3 justify-center">
                          <Button 
                            className="flex-1 bg-white border border-gray-300 hover:bg-gray-100 transition-colors text-black"
                            startContent={<FcGoogle className="text-xl" />}
